...
class Multi_Image_Uploader
{
    ...
    {
        $this->post_types = array('slide');     //limit meta box to certain post types
    ...
    public function render_meta_box_content($post)
    {
        ...
        $metabox_content = '<div id="miu_images"></div><input class="addRow" type="button" onClick="addRow()" value="Add Image" class="button" />';
